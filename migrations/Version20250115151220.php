 ...
 */
final class Version20250115151220 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE scenario (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, contexte VARCHAR(255) NOT NULL, niveau INT NOT NULL, image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
